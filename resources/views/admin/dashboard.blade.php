                ...
                <div class="row">
                        ...
                        <div class="card card-statistic-1">
                            <div class="card-wrap">
                                <div class="card-header">
                                    <h4 style="line-height: 33px;">Categories</h4>
                                </div>
                                <div class="card-body">
                                    {{ $categories->count() }}
                                </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-12" style="text-align:center">
                        <div class="card card-statistic-1">
                            <div class="card-wrap">
                                <div class="card-header">
                                    <h4 style="line-height: 33px;">Total Blog</h4>
                                </div>
                                <div class="card-body">
                                    {{ $totalBlog->count() }}
                                </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-12" style="text-align:center">
                        <div class="card card-statistic-1">
                            <div class="card-wrap">
                                <div class="card-header">
                                    <h4 style="line-height: 33px;">Today Blogs</h4>
                                </div>
                                <div class="card-body">
                                    {{ $todayBlogs->count() }}
                                </div>
                                                ...
                                                @if (!empty($order->assign_user_id == Auth::user()->id))
                                                    @if (Auth::user()->hasRole('Employee'))
                                                        <tr style="color:black">
                                                            ...
                                                            <td>{{ $order->created_at->format('d F, Y') }}
                                                                /{{ $order->ordered_delivery_time }} </td>
                                                            <td>{{ $order->product_qty }}</td>
                                                            <td>{{ $setting->currency_icon }}
                                                                {{ round($order->total_amount) }} </td>
                                                            <td>
                                                                @if ($order->order_status == 1)
                                                                    <span
                                                                        class="badge badge-success">{{ __('admin.Pregress') }}
                                                                    </span>
                                                                @elseif ($order->order_status == 2)
                                                                    <span
                                                                        class="badge badge-success">{{ __('admin.Delivered') }}
                                                                    </span>
